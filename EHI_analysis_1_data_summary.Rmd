...
```{r general_stats_data, eval=FALSE}
# Number of samples
ncol(count_table)

# Total amount of data in GBs (gigabases)
(discarded_bases + host_bases + metagenomic_bases)/1000000000
...
```{r general_stats_mags, eval=FALSE}
# Number of MAGs
nrow(count_table)
