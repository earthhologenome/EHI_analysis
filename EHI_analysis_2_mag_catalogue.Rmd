---
title: "EHI analysis - 2. MAG catalogue"
...
## 1.2. Plot phylogenetic tree

The next step is to plot the actual tree.
```{r tree_plot, eval=FALSE}
...
```{r mag_quality_biplot, eval=FALSE}
...
```{r mag_quality_completeness_boxplot, eval=FALSE}
...
```{r mag_quality_composite, eval=FALSE}
...
# 3. Functional attributes of MAGs
...
# 4. Functional ordination of MAGs
...
```{r mag_kegg_ordination, eval=FALSE}
